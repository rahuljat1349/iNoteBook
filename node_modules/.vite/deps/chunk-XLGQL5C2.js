import {
  ...
  shift,
  useFloating
} from "./chunk-AIPT3B3G.js";
import {
  FocusTrap,
  Portal,
  useModal
} from "./chunk-H5TIBHMI.js";
import {
  areArraysEqual,
...
// node_modules/@mui/joy/node_modules/@mui/base/FormControl/FormControl.js
init_extends();
init_objectWithoutPropertiesLoose();
...
// node_modules/@mui/joy/node_modules/@mui/base/FormControl/FormControlContext.js
...
// node_modules/@mui/joy/node_modules/@mui/base/FormControl/formControlClasses.js
...
// node_modules/@mui/joy/node_modules/@mui/base/FormControl/useFormControlContext.js
...
// node_modules/@mui/joy/node_modules/@mui/base/useInput/useInput.js
init_extends();
init_formatMuiErrorMessage();
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React31.useState(value ? String(value) : void 0);
  React31.useEffect(() => {
...
var InnerOption = React36.memo(React36.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React36.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React39.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React39.useRef(false);
  const handleEntering = React39.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React39.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React39.useCallback(() => {
    dispatch("exiting");
  }, []);
...
var selectClasses = generateUtilityClasses(COMPONENT_NAME14, ["root", "button", "listbox", "popper", "active", "expanded", "disabled", "focusVisible"]);
...
var TextareaAutosize = React64.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime42.jsxs)(React64.Fragment, {
...
var _excluded27 = ["children", "className", "lastTransitionedPropertyOnEnter", "lastTransitionedPropertyOnExit", "enterClassName", "exitClassName"];
function CssTransition(props) {
  ...
  const [isEntering, setIsEntering] = React66.useState(!requestedEnter);
  React66.useEffect(() => {
    if (requestedEnter) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XLGQL5C2.js.map
